...
urlpatterns = [
    # Pagination with subcategories
    path('articles/<slug:subcategory_slug>/', PostListView.as_view(model=Article, post_preview_template='Post/basic--post_preview-article.html', category='articles'), name='articles-list-by-category'),
    path('tools/<slug:subcategory_slug>/', PostListView.as_view(model=Tool, post_preview_template='Post/basic--post_preview-tool.html', category='tools'), name='tools-list-by-category'),
    # Pagination without subcategories
