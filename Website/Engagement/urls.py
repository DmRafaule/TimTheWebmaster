...
urlpatterns = [
    ...
    path('feedback_post/', V.feedback_post, name="feedback_form_post"),
    path('feedback_form/', V.feedback_form_get, name="feedback_form_get"),
    path('email_subscription/', V.email_post),
    path('email_subscription_form/', V.email_form_get, name="email_subscription_get"),
