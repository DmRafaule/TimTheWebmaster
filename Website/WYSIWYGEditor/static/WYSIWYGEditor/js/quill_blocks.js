...
export class TextBlock extends Quill.import('blots/block'){    
...
export class SomeBlock extends Quill.import('blots/block'){
    static create(value){
        let node = super.create(value);
    ...
    constructor(scroll, domNode) {
        ...
        legend_icon.setAttribute('width', 16)
        legend_icon.setAttribute('height', 16)
...
export function SomeBlockHandler(value){
    let values = value.split(',')
    let frm = values[1]
