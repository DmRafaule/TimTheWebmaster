export var MiniMasonry = (function () {
    "use strict";
    function t(t) {
        return (
            (this._sizes = []),
    ...
    return (
        (t.prototype.init = function (t) {
            ...
            window.addEventListener("resize", e),
                (this._removeListener = function () {
                    window.removeEventListener("resize", e), null != this._resizeTimeout && (window.clearTimeout(this._resizeTimeout), (this._resizeTimeout = null));
                }),
                this.layout();
        }),
        ...
        (t.prototype.layout = function () {
            if (this._container) {
                ...
                for (var e, n, r = this._container.children, s = 0; s < r.length; s++) (r[s].style.width = t + "px"), (this._sizes[s] = r[s].clientHeight);
                (e = "ltr" == this.conf.direction ? (this.conf.surroundingGutter ? this._currentGutterX : 0) : this._width - (this.conf.surroundingGutter ? this._currentGutterX : 0)),
                    this._count > this._sizes.length &&
                        ((n = this._sizes.length * (t + this._currentGutterX) - this._currentGutterX),
