...
BTCPAY_THANKS_PAGE = 'Main/BTCPayCrowdfunding/thanks-page.html'
BTCPAY_CROWDFUND_MAIL_RECEIPT_PAGE = 'Main/BTCPayCrowdfunding/receipt-email.html'
BTCPAY_CROWDFUND_THANKS_CONTEXT_CALLBACK = 'Main.utils.thanks_context_data'
BTCPAY_CROWDFUND_MAIL_RECEIPT_CONTEXT_CALLBACK = 'Main.utils.receipt_context_data'
