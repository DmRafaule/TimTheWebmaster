...
function drawScene() {
    ...
    {
        var lmat = math.lookAt(lightPosition, target, up);
        lmat = math.multiply4x4(math.xRotation(lightRotationX), lmat);
        lmat = math.multiply4x4(math.yRotation(lightRotationY), lmat);
...
var innerLimit = Degree2Radian(10);
var outerLimit = Degree2Radian(20);
...
slider_rotate_z.parentElement.previousElementSibling.textContent = "Outer limit"
slider_rotate_z.addEventListener('input', function(){
	var degree = parseInt(this.nextElementSibling.value)
	outerLimit = Degree2Radian(degree)
	drawScene() 
})
