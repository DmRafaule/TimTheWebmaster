...
export class TableTooltip{
    ...
    constructor(scroll, domNode, placeholder = ''){
        ...
        this.insertBtn(`${PATH}WYSIWYGEditor/img/table-insert-column-before.svg`, '', this.insertColumnBefore)
        this.insertSep()
        this.insertBtn(`${PATH}WYSIWYGEditor/img/table-top-header.svg`, '', this.toggleHeader)
        this.insertSep()
        this.insertBtn(`${PATH}WYSIWYGEditor/img/table-delete-row.svg`, '', this.removeRow)
        this.insertBtn(`${PATH}WYSIWYGEditor/img/table-delete-column.svg`, '', this.removeCol)
        this.insertSep()
        this.insertBtn(`${PATH}WYSIWYGEditor/img/table-delete.svg`, '', this.removeTable)
    }
    insertSep(){
    ...
    insertBtn(iconPath, popupText, callback){
        ...
        icon.classList.add('ttw-button_squared')
        icon.classList.add('p-1')
        icon.width = '32'
        icon.height = '32'
        icon.src = iconPath
        let container = document.createElement('div')
        container.classList.add('ttw-button')
        container.classList.add('ttw-button_action')
...
export class CustomTable extends Quill.import('modules/table'){
